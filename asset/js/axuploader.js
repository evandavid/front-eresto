		...
		init : function(options)
		{
    	    ...
    	    return this.each(function() 
    	    {
			   ...
			   // isAjaxUpload=false;
				...
				\*================================================================================*/
				var uploadAll=$('<input style="margin-left:5px;" type="button" value="Upload all" class="ax-uploadall btn btn-success" />').attr('disabled',true).appendTo(mainForm).bind('click',function(){
					if(isAjaxUpload)
					{
				...
				\*================================================================================*/
				var clear=$('<input style="margin-left:5px;" type="button" value="Clear" class="ax-clear btn btn-warning" />').appendTo(mainForm).bind('click',function(){
					fileCount=0;
					totalFiles=0;
				...
				\*================================================================================*/
			    var fileList=$('<table class="ax-file-list table table-striped table-hover" />').append('<thead><tr>'+
													 	'<th>File</th>'+
													 	'<th>Size</th>'+
													 	'<th>Progress</th>'+
													 	'<th>Remove</th>'+
				...
				function add_file(t,o,n,s,numF)
				{
					...
					var rm=$('<input type="button" class="btn btn-danger" value="Remove" />').bind('click',function(){
						fileCount--;
						totalFiles--;
						uploadAll.attr('disabled',fileCount==0);
					...
					var up=$('<input type="button" value="Upload" class="ax-upload btn btn-info" />').bind('click',function(){ this.disabled=true; });
					...
					var div_p=$('<div  class="ax-progress-div" />').css({'width':'0%'}).html(0).appendTo(td_p);
